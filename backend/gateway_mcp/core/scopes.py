...
This is a stub implementation for Milestone 4. Full credential
and scope validation is implemented in Milestone 7.
"""
...
class ScopeService:
    ...
    def __init__(
        self,
        credential_store=None,  # Will be CredentialStore from Milestone 7
        ...
        Args:
            credential_store: Credential storage backend (optional until M7)
    ...
    def _get_user_credential(
        ...
        Stub implementation until Milestone 7 credential store.
        Returns None (credential missing) for now.
        """
        if self._credential_store is None:
            # Milestone 7 not implemented yet
            return None
        
        # Future: return self._credential_store.get_credential(user_id, provider)
        return None
...
def create_scope_service_from_settings(settings) -> ScopeService:
    """
    ...
    return ScopeService(
        credential_store=None,  # Milestone 7
