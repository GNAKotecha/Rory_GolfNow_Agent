...
import { TenantSkill, TenantSkillUpdate } from '@/lib/api';
import {
  resetSkillForm,
  validateSkillJSON,
  SkillFormData,
...
interface EditSkillModalProps {
  ...
  onClose: () => void;
  onSave: (data: TenantSkillUpdate) => Promise<void>;
  loading: boolean;
}
  ...
  useEffect(() => {
    if (skill && isOpen) {
      setFormData({
        ...
        skill_data: JSON.stringify(skill.skill_data, null, 2),
      });
      setError(null);
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded text-sm text-blue-800">
            ID: {skill.id} | Version: {skill.version} | Created by: {skill.created_by}
          </div>
